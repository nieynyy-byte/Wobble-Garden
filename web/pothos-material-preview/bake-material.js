...
export function makePothosMaterial({seed,coverage,young=false,width=256,height=512}){
 const rng=random(seed),W=width,H=height,pixels=new Uint8Array(W*H*4),rough=new Uint8Array(W*H*4);
